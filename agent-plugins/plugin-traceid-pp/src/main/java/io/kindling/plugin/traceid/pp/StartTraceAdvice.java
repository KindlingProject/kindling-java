...
@AdvicePointCut(
    ...
    matchMethods = {
        "newTraceObject", // (), (java.lang.String)
        "newAsyncTraceObject", // (), (java.lang.String)
        "continueTraceObject", // (com.navercorp.pinpoint.bootstrap.context.Trace), (com.navercorp.pinpoint.bootstrap.context.TraceId)
        "continueAsyncTraceObject" // (com.navercorp.pinpoint.bootstrap.context.TraceId)
    },
    matchParams = "(..)"
)
public class StartTraceAdvice implements AfterAdvice {
    ...
    public void after(JoinPoint joinPoint) {
        ...
        if (trace != null && trace.canSampled()) {
            KindlingApi.enter(trace.getTraceId().getTransactionId());
        }
    }
